...
$remplazar = "INSERT INTO citasambientes (anio,sems,codarea,mes,dia,hora,codalu,fechagen) ";
$remplazar .= "VALUES ('$anio','$sems','$codarea','$mes','$dia','$hora','$codigo','$fechaH') ";
$remplazar .= "ON DUPLICATE KEY UPDATE fechagen='$fechaH' ";
