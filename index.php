...
$ip = getRealIP();
$_SESSION['ip'] = $ip;//Ip con la que se va a verificar en todos los modulos
...
<title>Login</title>
<link rel="stylesheet" type="text/css" href="estilosLogin.css?v=1.6"/>
		...
		<header>
			<div id="contenedor-header">
				...
				<div id="menu" class="eHeader">
					<div class="menu-opcion activo">Login</div>
